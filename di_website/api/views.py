...
def spotlight_pages_view(request):
    ...
    for spotlight in spotlights:
        page = serialise_page(request, spotlight, fields=['title', 'full_url', 'country_code', 'country_name', 'currency_code', 'datasources_description', 'datasources_url', 'datasources_url_title'])
