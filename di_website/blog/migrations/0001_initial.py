# Generated by Django 2.2.2 on 2019-07-19 18:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('related_pages', wagtail.core.fields.StreamField([('page', wagtail.core.blocks.PageChooserBlock(page_type=['blog.BlogArticlePage']))], blank=True, null=True)),
                ...
                ('topic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='blog.BlogTopic')),
            ],
            options={
                'abstract': False,
            },
