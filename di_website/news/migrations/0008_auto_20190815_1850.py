    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_box', wagtail.fields.StreamField([('contact', wagtail.blocks.StructBlock([('name', wagtail.blocks.CharBlock(required=False)), ('telephone', wagtail.blocks.CharBlock(required=False)), ('email', wagtail.blocks.CharBlock(required=False))]))], blank=True, null=True)),
                ('spokespeople', wagtail.fields.StreamField([('spokesperson', wagtail.blocks.StructBlock([('person', wagtail.blocks.PageChooserBlock(page_type=['ourteam.TeamMemberPage'], required=False))]))], blank=True, null=True)),
