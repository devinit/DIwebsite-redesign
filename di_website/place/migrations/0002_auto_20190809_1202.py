...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='placespage',
            name='places',
            field=wagtail.fields.StreamField([('place', wagtail.blocks.StructBlock([('title', wagtail.blocks.TextBlock()), ('subtitle', wagtail.blocks.TextBlock(required=False)), ('image', wagtail.images.blocks.ImageChooserBlock(required=False)), ('body', wagtail.blocks.RichTextBlock(features=['h2', 'h3', 'h4', 'bold', 'italic', 'ol', 'ul', 'link', 'document', 'image', 'embed'], icon='fa-paragraph', template='blocks/paragraph_block.html')), ('side_section_title', wagtail.blocks.TextBlock(required=False)), ('links', wagtail.blocks.StreamBlock([('link', wagtail.blocks.StructBlock([('caption', wagtail.blocks.CharBlock(required=False)), ('url', wagtail.blocks.URLBlock(required=False)), ('page', wagtail.blocks.PageChooserBlock(required=False))]))], required=False))]))], blank=True, null=True, verbose_name='Places'),
        ),
    ]
