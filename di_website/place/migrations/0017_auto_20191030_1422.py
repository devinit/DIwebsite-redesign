...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='placespage',
            name='places',
            field=wagtail.fields.StreamField([('place', wagtail.blocks.StructBlock([('title', wagtail.blocks.TextBlock()), ('subtitle', wagtail.blocks.TextBlock(required=False)), ('image', wagtail.images.blocks.ImageChooserBlock(required=False)), ('body', wagtail.blocks.RichTextBlock(features=['h2', 'h3', 'h4', 'bold', 'italic', 'ol', 'ul', 'hr', 'link', 'document-link', 'image', 'embed', 'anchor', 'footnote'], icon='fa-paragraph', template='blocks/paragraph_block.html')), ('side_section_title', wagtail.blocks.TextBlock(required=False)), ('links', wagtail.blocks.StreamBlock([('link', wagtail.blocks.StructBlock([('caption', wagtail.blocks.CharBlock(help_text='Leave blank if you wish to use the page title as a caption', required=False)), ('page', wagtail.blocks.PageChooserBlock(help_text='For the link/button to show, either this or the url are required', required=False)), ('url', wagtail.blocks.URLBlock(help_text='An alternative to an internal page', required=False))]))], required=False))]))], blank=True, null=True, verbose_name='Places'),
        ),
    ]
