# Generated by Django 2.2.4 on 2019-08-20 12:09
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('project', '0012_auto_20190816_1042'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='focusareaspagelink',
            name='focus_area_image',
            field=wagtail.fields.StreamField([('image', wagtail.images.blocks.ImageChooserBlock(required=True))], blank=True, null=True),
        ),
        migrations.AddField(
            model_name='focusareaspagelink',
            name='focus_area_sub_paragraph',
            field=models.CharField(blank=True, max_length=255, null=True, verbose_name='Paragraph'),
        ),
        migrations.AddField(
            model_name='focusareaspagelink',
            name='focus_area_sub_title',
