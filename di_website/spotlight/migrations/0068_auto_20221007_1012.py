...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('spotlight', '0067_alter_countryspotlight_body'),
    ]
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            name='config',
            field=wagtail.fields.StreamField([('JSON', wagtail.blocks.StructBlock([('content', wagtail.blocks.TextBlock(form_classname='ace-editor-json-block', help_text='Enter your JSON here', label='JSON Content'))]))], blank=True, null=True, use_json_field=True, verbose_name='JSON Config'),
        ),
        migrations.AlterField(
            model_name='spotlightlocationcomparisonpage',
            name='default_locations',
            field=wagtail.fields.StreamField([('locations', wagtail.blocks.StructBlock([('name', wagtail.blocks.TextBlock()), ('geocode', wagtail.blocks.TextBlock())]))], blank=True, null=True, use_json_field=True, verbose_name='Default Locations'),
        ),
        migrations.AlterField(
            model_name='spotlightpage',
            name='datasources_links',
            field=wagtail.fields.StreamField([('link', wagtail.blocks.StructBlock([('caption', wagtail.blocks.CharBlock(help_text='Leave blank if you wish to use the page title as a caption', required=False)), ('page', wagtail.blocks.PageChooserBlock(help_text='For the link/button to show, either this or the url are required', required=False)), ('url', wagtail.blocks.URLBlock(help_text='An alternative to an internal page', required=False))]))], blank=True, null=True, use_json_field=True, verbose_name='Links'),
        ),
    ]
