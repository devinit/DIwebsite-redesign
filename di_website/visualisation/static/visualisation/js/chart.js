...
/******/ 		return __webpack_require__.p + "" + chunkId + ".chart.js"
/******/ 	}
/******/
...
/******/ 	__webpack_require__.p = "/assets/visualisation/js/";
/******/
...
/***/ "./src/visualisation/click.ts":
/*!************************************!*\
  !*** ./src/visualisation/click.ts ***!
  \************************************/
/*! exports provided: dblclickLegendItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"dblclickLegendItem\", function() { return dblclickLegendItem; });\n// trigger a double click on an element\nvar dblclick = function dblclick(node, descendentSelector, index) {\n  var item = node.querySelectorAll(descendentSelector)[index];\n  item.dispatchEvent(new MouseEvent('mousedown'));\n  item.dispatchEvent(new MouseEvent('mouseup'));\n  item.dispatchEvent(new MouseEvent('mousedown'));\n  item.dispatchEvent(new MouseEvent('mouseup'));\n}; // trigger a double click on a legend element\n\n\nvar dblclickLegendItem = function dblclickLegendItem(legend, index) {\n  dblclick(legend, 'rect.legendtoggle', index);\n};\n\n//# sourceURL=webpack:///./src/visualisation/click.ts?");

/***/ }),

/***/ "./src/visualisation/config.ts":
/*!*************************************!*\
  !*** ./src/visualisation/config.ts ***!
  \*************************************/
/*! exports provided: minWidth, config */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"minWidth\", function() { return minWidth; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"config\", function() { return config; });\n// min width at which interactive chart should be displayed at\nvar minWidth = 700; // config object for new plots\n\nvar config = {\n  displayModeBar: true,\n  responsive: true,\n  showLink: true,\n  plotlyServerURL: 'https://chart-studio.plotly.com',\n  toImageButtonOptions: {\n    width: 1200,\n    height: 657\n  },\n  modeBarButtonsToRemove: ['pan2d', 'select2d', 'lasso2d', 'hoverClosestCartesian', 'hoverCompareCartesian', 'toggleSpikelines']\n};\n\n//# sourceURL=webpack:///./src/visualisation/config.ts?");

/***/ }),

/***/ "./src/visualisation/data.ts":
/*!***********************************!*\
  !*** ./src/visualisation/data.ts ***!
  \***********************************/
/*! exports provided: getTreemapData */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getTreemapData\", function() { return getTreemapData; });\n// get data for treemap based on selected label\nvar getTreemapData = function getTreemapData(traces, label) {\n  var newDataIndex = traces.findIndex(function (el) {\n    return el.name == label;\n  });\n  return [traces[newDataIndex]];\n};\n\n//# sourceURL=webpack:///./src/visualisation/data.ts?");

/***/ }),

/***/ "./src/visualisation/index.ts":
/*!************************************!*\
  !*** ./src/visualisation/index.ts ***!
  \************************************/
/*! no exports provided */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _click__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./click */ \"./src/visualisation/click.ts\");\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./config */ \"./src/visualisation/config.ts\");\n/* harmony import */ var _data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./data */ \"./src/visualisation/data.ts\");\n/* harmony import */ var _loading__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./loading */ \"./src/visualisation/loading.ts\");\n/* harmony import */ var _options__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./options */ \"./src/visualisation/options.ts\");\n/* harmony import */ var _modules__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules */ \"./src/visualisation/modules.ts\");\n/* harmony import */ var _styles__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./styles */ \"./src/visualisation/styles.ts\");\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n\n\n\n\n\n\n\n\n// Find and initiliase all charts\nvar initPlotlyCharts = function initPlotlyCharts() {\n  var wrappers = document.getElementsByClassName('js-plotly-chart-wrapper');\n\n  if (wrappers.length) {\n    for (var index = 0; index < wrappers.length; index++) {\n      var element = wrappers.item(index);\n\n      if (element) {\n        (function () {\n          var chartNode = element.getElementsByClassName('js-plotly-chart')[0];\n          var selectNode = element.getElementsByClassName('js-plotly-chart-data-selector')[0];\n          var scriptNode = element.getElementsByClassName('js-plotly-chart-raw-data')[0];\n\n          if (chartNode) {\n            var data = scriptNode ? JSON.parse(scriptNode.innerHTML) : null; // TODO: surround in try/catch\n\n            var url = chartNode.dataset.url;\n            var aggregated = chartNode.dataset.aggregated;\n\n            var init = function init() {\n              // if window greater than min and chart not inited, init chart and set flag\n              if (window.matchMedia(\"(min-width: \".concat(_config__WEBPACK_IMPORTED_MODULE_1__[\"minWidth\"], \"px)\")).matches) {\n                // add loading on chart init\n                Object(_loading__WEBPACK_IMPORTED_MODULE_3__[\"addLoading\"])(chartNode); // async data is used for live/page embedded chart requests\n\n                if (url) {\n                  fetch(url).then(function (response) {\n                    response.json().then(function (d) {\n                      if (selectNode) {\n                        initSelectableChart(chartNode, d, selectNode, aggregated === 'True');\n                      } else {\n                        initStaticChart(chartNode, d);\n                      }\n                    });\n                  });\n                } // raw data in the page is used for previewing and drafts\n                else {\n                    if (selectNode) {\n                      initSelectableChart(chartNode, data, selectNode, aggregated === 'True');\n                    } else {\n                      initStaticChart(chartNode, data);\n                    }\n                  } // remove listener if chart inited\n\n\n                removelistener();\n              }\n            }; // add the window resize listener\n\n\n            window.addEventListener('resize', init); // remove the window resize listener\n\n            var removelistener = function removelistener() {\n              window.removeEventListener('resize', init);\n            }; // call the init function\n\n\n            init();\n          }\n        })();\n      }\n    }\n  }\n}; // Initiliase a static chart\n\n\nvar initStaticChart = /*#__PURE__*/function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(element, chartConfig) {\n    var data, layout, _yield$loadPlotlyCode, newPlot;\n\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            _context.prev = 0;\n            data = chartConfig.data, layout = chartConfig.layout;\n            _context.next = 4;\n            return Object(_modules__WEBPACK_IMPORTED_MODULE_5__[\"loadPlotlyCode\"])(data);\n\n          case 4:\n            _yield$loadPlotlyCode = _context.sent;\n            newPlot = _yield$loadPlotlyCode.newPlot;\n            // const config = { responsive: true };\n            Object(_loading__WEBPACK_IMPORTED_MODULE_3__[\"removeLoading\"])(element);\n            Object(_styles__WEBPACK_IMPORTED_MODULE_6__[\"removeTitle\"])(layout);\n            Object(_styles__WEBPACK_IMPORTED_MODULE_6__[\"updateDataHoverTemplate\"])(data);\n            Object(_styles__WEBPACK_IMPORTED_MODULE_6__[\"updateLayoutColorway\"])(layout);\n            newPlot(element, data, layout, _config__WEBPACK_IMPORTED_MODULE_1__[\"config\"]);\n            _context.next = 16;\n            break;\n\n          case 13:\n            _context.prev = 13;\n            _context.t0 = _context[\"catch\"](0);\n            console.log(_context.t0);\n\n          case 16:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee, null, [[0, 13]]);\n  }));\n\n  return function initStaticChart(_x, _x2) {\n    return _ref.apply(this, arguments);\n  };\n}(); // Initiliase an selectable chart\n\n\nvar initSelectableChart = /*#__PURE__*/function () {\n  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(chartNode, chartConfig, selectNode) {\n    var aggregated,\n        _data,\n        layout,\n        _yield$loadPlotlyCode2,\n        newPlot,\n        react,\n        all,\n        data,\n        traces,\n        options,\n        isTreemap,\n        lastSelected,\n        legend,\n        legendOpts,\n        updateData,\n        _args2 = arguments;\n\n    return regeneratorRuntime.wrap(function _callee2$(_context2) {\n      while (1) {\n        switch (_context2.prev = _context2.next) {\n          case 0:\n            aggregated = _args2.length > 3 && _args2[3] !== undefined ? _args2[3] : false;\n            _context2.prev = 1;\n            _data = chartConfig.data, layout = chartConfig.layout;\n            _context2.next = 5;\n            return Object(_modules__WEBPACK_IMPORTED_MODULE_5__[\"loadPlotlyCode\"])(_data);\n\n          case 5:\n            _yield$loadPlotlyCode2 = _context2.sent;\n            newPlot = _yield$loadPlotlyCode2.newPlot;\n            react = _yield$loadPlotlyCode2.react;\n            all = 'All data';\n            data = _data.slice();\n            traces = Array.from(data);\n            options = [];\n            isTreemap = data[0].type === 'treemap';\n            lastSelected = -1;\n            legend = undefined; // enable the legend and add opts\n\n            if (!isTreemap) {\n              legendOpts = Object.assign(layout.legend || {}, {\n                x: 1,\n                xanchor: 'right',\n                y: 1\n              });\n              layout.showlegend = true;\n              layout.legend = legendOpts;\n            } // remove loading from inited chart\n\n\n            Object(_loading__WEBPACK_IMPORTED_MODULE_3__[\"removeLoading\"])(chartNode); // remove the title\n\n            Object(_styles__WEBPACK_IMPORTED_MODULE_6__[\"removeTitle\"])(layout); // update the hover template\n\n            Object(_styles__WEBPACK_IMPORTED_MODULE_6__[\"updateDataHoverTemplate\"])(data); // update the layout colorway\n\n            Object(_styles__WEBPACK_IMPORTED_MODULE_6__[\"updateLayoutColorway\"])(layout); // set the data to the first item if treemap\n\n            if (isTreemap) {\n              data = [traces[0]];\n            } // change event listener\n\n\n            updateData = function updateData() {\n              // get the selected index, which will be one higher than required if aggregated\n              var index = aggregated ? selectNode.selectedIndex - 1 : selectNode.selectedIndex; // if treemap, set the data to the selected index and redraw\n\n              if (isTreemap) {\n                data = Object(_data__WEBPACK_IMPORTED_MODULE_2__[\"getTreemapData\"])(traces, selectNode.value);\n                react(chartNode, data, layout);\n              } // otherwise use the legend to update the chart\n              else {\n                  // if this is the first selection trigger double click\n                  if (lastSelected == -1) {\n                    Object(_click__WEBPACK_IMPORTED_MODULE_0__[\"dblclickLegendItem\"])(legend, index);\n                  } // if it's not the first click, then handle resetting the view and selecting the new index\n                  else {\n                      // if the data is grouped we need to doubleclick the last element to reset the view\n                      if (data.length == 1) {\n                        Object(_click__WEBPACK_IMPORTED_MODULE_0__[\"dblclickLegendItem\"])(legend, lastSelected); // if index is less than zero, it's an all data reset so don't click again\n\n                        if (index > -1) {\n                          Object(_click__WEBPACK_IMPORTED_MODULE_0__[\"dblclickLegendItem\"])(legend, index);\n                        }\n                      } else {\n                        // if index is less than zero, just click the last selected again to reset\n                        if (index < 0) {\n                          Object(_click__WEBPACK_IMPORTED_MODULE_0__[\"dblclickLegendItem\"])(legend, lastSelected);\n                        } // otherwise reset and then click the selected index\n                        else {\n                            Object(_click__WEBPACK_IMPORTED_MODULE_0__[\"dblclickLegendItem\"])(legend, lastSelected);\n                            Object(_click__WEBPACK_IMPORTED_MODULE_0__[\"dblclickLegendItem\"])(legend, index);\n                          }\n                      }\n                    } // store the selected index\n\n\n                  lastSelected = index;\n                }\n            }; // initialise the chart and selector\n\n\n            newPlot(chartNode, data, layout, _config__WEBPACK_IMPORTED_MODULE_1__[\"config\"]).then(function () {\n              // store a reference to the legend and hide it\n              try {\n                legend = chartNode.querySelectorAll('.legend')[0];\n                legend.style.cssText = 'display: none;';\n              } catch (e) {} // create options list from legend (or data if treemap)\n\n\n              var options = Object(_options__WEBPACK_IMPORTED_MODULE_4__[\"getOptions\"])(legend, traces); // add an extra all data option at the top if aggregated\n\n              if (!isTreemap && aggregated) {\n                options.unshift(all);\n              } else {\n                // otherwise select the first legend item\n                try {\n                  lastSelected = 0;\n                  Object(_click__WEBPACK_IMPORTED_MODULE_0__[\"dblclickLegendItem\"])(legend, lastSelected);\n                } catch (e) {}\n              } // get the select and assign options\n\n\n              Object(_options__WEBPACK_IMPORTED_MODULE_4__[\"assignOptions\"])(selectNode, options); // assign change event listener\n\n              selectNode.addEventListener('change', updateData, false);\n            });\n            _context2.next = 28;\n            break;\n\n          case 25:\n            _context2.prev = 25;\n            _context2.t0 = _context2[\"catch\"](1);\n            // if there's a problem then try a static chart\n            initStaticChart(chartNode, chartConfig);\n\n          case 28:\n          case \"end\":\n            return _context2.stop();\n        }\n      }\n    }, _callee2, null, [[1, 25]]);\n  }));\n\n  return function initSelectableChart(_x3, _x4, _x5) {\n    return _ref2.apply(this, arguments);\n  };\n}(); // Begin initialisation\n\n\ninitPlotlyCharts();\n\n//# sourceURL=webpack:///./src/visualisation/index.ts?");

/***/ }),

/***/ "./src/visualisation/loading.ts":
/*!**************************************!*\
  !*** ./src/visualisation/loading.ts ***!
  \**************************************/
/*! exports provided: addLoading, removeLoading */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"addLoading\", function() { return addLoading; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"removeLoading\", function() { return removeLoading; });\n// add loading on chart init\nvar addLoading = function addLoading(el) {\n  var loading = document.createElement('div');\n  loading.innerHTML = '<div class=\"chart-loading__block\">' + '<div></div><div></div><div></div><div></div></div>';\n  loading.classList.add('chart-loading');\n  el.classList.add('chart-container--loading');\n  el.prepend(loading);\n}; // remove loading from inited chart\n\nvar removeLoading = function removeLoading(element) {\n  element.classList.remove('chart-container--loading');\n  var loadingIndicator = element.querySelector('.chart-loading');\n\n  if (loadingIndicator) {\n    loadingIndicator.remove();\n  }\n};\n\n//# sourceURL=webpack:///./src/visualisation/loading.ts?");

/***/ }),

/***/ "./src/visualisation/modules.ts":
/*!**************************************!*\
  !*** ./src/visualisation/modules.ts ***!
  \**************************************/
/*! exports provided: loadPlotlyCode */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"loadPlotlyCode\", function() { return loadPlotlyCode; });\nfunction asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }\n\nfunction _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"next\", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, \"throw\", err); } _next(undefined); }); }; }\n\n// Get and return the correct plotly module based on chart type\nvar loadPlotlyCode = /*#__PURE__*/function () {\n  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {\n    var chartBundles, isChartType, _i, _Object$values, bundle, hasGroupedByTransform;\n\n    return regeneratorRuntime.wrap(function _callee$(_context) {\n      while (1) {\n        switch (_context.prev = _context.next) {\n          case 0:\n            chartBundles = {\n              basicCharts: {\n                types: ['bar', 'scatter', 'pie'],\n                dist: function dist() {\n                  return __webpack_require__.e(/*! import() */ 1).then(__webpack_require__.t.bind(null, /*! plotly.js-basic-dist */ \"./node_modules/plotly.js-basic-dist/plotly-basic.js\", 7));\n                }\n              },\n              cartesianCharts: {\n                types: ['box', 'heatmap', 'histogram', 'histogram2d', 'histogram2dcontour', 'image', 'contour', 'scatterternary', 'violin'],\n                dist: function dist() {\n                  return __webpack_require__.e(/*! import() */ 2).then(__webpack_require__.t.bind(null, /*! plotly.js-cartesian-dist */ \"./node_modules/plotly.js-cartesian-dist/plotly-cartesian.js\", 7));\n                }\n              },\n              financeCharts: {\n                types: ['histogram', 'funnelarea', 'ohlc', 'candlestick', 'funnel', 'waterfall', 'indicator'],\n                dist: function dist() {\n                  return __webpack_require__.e(/*! import() */ 3).then(__webpack_require__.t.bind(null, /*! plotly.js-finance-dist */ \"./node_modules/plotly.js-finance-dist/plotly-finance.js\", 7));\n                }\n              },\n              geoCharts: {\n                types: ['scattergeo', 'choropleth'],\n                dist: function dist() {\n                  return __webpack_require__.e(/*! import() */ 4).then(__webpack_require__.t.bind(null, /*! plotly.js-geo-dist */ \"./node_modules/plotly.js-geo-dist/plotly-geo.js\", 7));\n                }\n              },\n              geo2dCharts: {\n                types: ['scattergl', 'splom', 'pointcloud', 'heatmapgl', 'contourgl', 'parcoords'],\n                dist: function dist() {\n                  return __webpack_require__.e(/*! import() */ 5).then(__webpack_require__.t.bind(null, /*! plotly.js-gl2d-dist */ \"./node_modules/plotly.js-gl2d-dist/plotly-gl2d.js\", 7));\n                }\n              },\n              geo3dCharts: {\n                types: ['scatter3d', 'surface', 'mesh3d', 'isosurface', 'volume', 'cone', 'streamtube'],\n                dist: function dist() {\n                  return __webpack_require__.e(/*! import() */ 6).then(__webpack_require__.t.bind(null, /*! plotly.js-gl3d-dist */ \"./node_modules/plotly.js-gl3d-dist/plotly-gl3d.js\", 7));\n                }\n              },\n              mapboxCharts: {\n                types: ['scattermapbox', 'choroplethmapbox', 'densitymapbox'],\n                dist: function dist() {\n                  return __webpack_require__.e(/*! import() */ 7).then(__webpack_require__.t.bind(null, /*! plotly.js-mapbox-dist */ \"./node_modules/plotly.js-mapbox-dist/plotly-mapbox.js\", 7));\n                }\n              }\n            };\n\n            isChartType = function isChartType(chartTypes) {\n              return chartTypes.filter(function (chart) {\n                return data.find(function (_data) {\n                  return _data.type === chart;\n                });\n              }).length;\n            };\n\n            _i = 0, _Object$values = Object.values(chartBundles);\n\n          case 3:\n            if (!(_i < _Object$values.length)) {\n              _context.next = 15;\n              break;\n            }\n\n            bundle = _Object$values[_i];\n            // basic doesn't allow groupby transforms, so test that first\n            hasGroupedByTransform = false;\n\n            try {\n              hasGroupedByTransform = data[0].transforms[0].type == 'groupby';\n            } catch (e) {} // if no groupedby transform present, try to get the module based on matching type\n\n\n            if (hasGroupedByTransform) {\n              _context.next = 12;\n              break;\n            }\n\n            if (!isChartType(bundle.types)) {\n              _context.next = 12;\n              break;\n            }\n\n            _context.next = 11;\n            return bundle.dist();\n\n          case 11:\n            return _context.abrupt(\"return\", _context.sent);\n\n          case 12:\n            _i++;\n            _context.next = 3;\n            break;\n\n          case 15:\n            _context.next = 17;\n            return Promise.all(/*! import() */[__webpack_require__.e(0), __webpack_require__.e(8)]).then(__webpack_require__.t.bind(null, /*! plotly.js */ \"./node_modules/plotly.js/lib/index.js\", 7));\n\n          case 17:\n            return _context.abrupt(\"return\", _context.sent);\n\n          case 18:\n          case \"end\":\n            return _context.stop();\n        }\n      }\n    }, _callee);\n  }));\n\n  return function loadPlotlyCode(_x) {\n    return _ref.apply(this, arguments);\n  };\n}();\n\n//# sourceURL=webpack:///./src/visualisation/modules.ts?");

/***/ }),

/***/ "./src/visualisation/options.ts":
/*!**************************************!*\
  !*** ./src/visualisation/options.ts ***!
  \**************************************/
/*! exports provided: assignOption, assignOptions, getOptions */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"assignOption\", function() { return assignOption; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"assignOptions\", function() { return assignOptions; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"getOptions\", function() { return getOptions; });\n// Assign an option to a select node\nvar assignOption = function assignOption(selectNode, value) {\n  var currentOption = document.createElement('option');\n  currentOption.text = value;\n  selectNode.appendChild(currentOption);\n}; // Take an array of strings and assign as options to a select node\n\nvar assignOptions = function assignOptions(selectNode, options) {\n  if (!options.length) {\n    return;\n  }\n\n  options.forEach(function (option) {\n    if (!option) {\n      return;\n    }\n\n    assignOption(selectNode, option);\n  });\n  selectNode.classList.add('data-selector--active');\n}; // get the options from the legend items\n\nvar getOptions = function getOptions(legend, traces) {\n  if (legend) {\n    var options = [];\n    legend.querySelectorAll('.legendtext').forEach(function (el) {\n      return options.push(el.dataset.unformatted);\n    });\n    return options;\n  }\n\n  return traces.map(function (el) {\n    return el.name;\n  });\n};\n\n//# sourceURL=webpack:///./src/visualisation/options.ts?");

/***/ }),

/***/ "./src/visualisation/styles.ts":
/*!*************************************!*\
  !*** ./src/visualisation/styles.ts ***!
  \*************************************/
/*! exports provided: updateDataHoverTemplate, updateLayoutColorway, removeTitle */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"updateDataHoverTemplate\", function() { return updateDataHoverTemplate; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"updateLayoutColorway\", function() { return updateLayoutColorway; });\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"removeTitle\", function() { return removeTitle; });\n// Default hover template\nvar hovertemplate = '<b>%{fullData.meta.columnNames.y}</b><br>' + '%{xaxis.title.text}: <b>%{x}</b><br>' + '%{yaxis.title.text}: <b>%{y}</b><extra></extra>'; // Assign the default hover template to each data node if there isn't one defined\n\nvar updateDataHoverTemplate = function updateDataHoverTemplate(data) {\n  data.forEach(function (item) {\n    if (!item.hovertemplate) {\n      item.hovertemplate = hovertemplate;\n    }\n  });\n}; // Assign a new colorway to the layout\n\nvar updateLayoutColorway = function updateLayoutColorway(layout) {\n  layout.colorway = [\"#e84439\", \"#eb642b\", \"#f49b21\", \"#109e68\", \"#0089cc\", \"#893f90\", \"#c2135b\", \"#f8c1b2\", \"#fccc8e\", \"#f6bb9d\", \"#92cba9\", \"#88bae5\", \"#c189bb\", \"#e4819b\"];\n}; // remove the chart title\n\nvar removeTitle = function removeTitle(layout) {\n  try {\n    layout.title.text = '';\n  } catch (e) {}\n};\n\n//# sourceURL=webpack:///./src/visualisation/styles.ts?");

/***/ }),

/***/ 0:
/*!**********************************************************!*\
  !*** multi @babel/polyfill ./src/visualisation/index.ts ***!
  \**********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! @babel/polyfill */\"./node_modules/@babel/polyfill/lib/index.js\");\nmodule.exports = __webpack_require__(/*! ./src/visualisation/index.ts */\"./src/visualisation/index.ts\");\n\n\n//# sourceURL=webpack:///multi_@babel/polyfill_./src/visualisation/index.ts?");
