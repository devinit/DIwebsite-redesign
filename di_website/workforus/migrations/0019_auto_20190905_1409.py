# Generated by Django 2.2.4 on 2019-09-05 14:09

import di_website.workforus.models
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('workforus', '0018_workforuspage_vacancy_heading'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            name='ourvalues',
            field=wagtail.core.fields.StreamField([('item', wagtail.core.blocks.StructBlock([('ourvalues', wagtail.snippets.blocks.SnippetChooserBlock(di_website.workforus.models.Values))]))], blank=True, null=True, verbose_name='Our Values Chooser'),
        ),
