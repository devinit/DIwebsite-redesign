...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            name='benefits',
            field=wagtail.fields.StreamField([('benefit', wagtail.blocks.StructBlock([('title', wagtail.blocks.TextBlock()), ('body', wagtail.blocks.RichTextBlock(features=['h2', 'h3', 'h4', 'bold', 'italic', 'ol', 'ul', 'hr', 'link', 'document-link', 'image', 'embed'], required=False)), ('image', wagtail.images.blocks.ImageChooserBlock(required=False))])), ('logo', wagtail.images.blocks.ImageChooserBlock(required=False))], blank=True, null=True, verbose_name='Benefits'),
        ),
        migrations.AlterField(
            model_name='workforuspage',
            name='body',
