...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('workforus', '0020_auto_20191126_1402'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='benefits',
            field=wagtail.core.fields.StreamField([('benefit', wagtail.core.blocks.StructBlock([('title', wagtail.core.blocks.TextBlock()), ('body', wagtail.core.blocks.RichTextBlock(features=['h2', 'h3', 'h4', 'bold', 'italic', 'ol', 'ul', 'hr', 'link', 'document-link', 'image', 'embed'], required=False)), ('image', wagtail.images.blocks.ImageChooserBlock(required=False))])), ('logo', wagtail.images.blocks.ImageChooserBlock(required=False))], blank=True, null=True, verbose_name='Benefits'),
        ),
        migrations.AlterField(
            model_name='workforuspage',
            name='body',
