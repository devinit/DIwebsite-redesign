...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('workforus', '0024_alter_workforuspage_body'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='benefits',
            field=wagtail.fields.StreamField([('benefit', wagtail.blocks.StructBlock([('title', wagtail.blocks.TextBlock()), ('body', wagtail.blocks.RichTextBlock(features=['h2', 'h3', 'h4', 'bold', 'italic', 'ol', 'ul', 'hr', 'link', 'document-link', 'image', 'embed', 'anchor'], required=False)), ('image', wagtail.images.blocks.ImageChooserBlock(required=False))])), ('logo', wagtail.images.blocks.ImageChooserBlock(required=False))], blank=True, null=True, use_json_field=True, verbose_name='Benefits'),
        ),
        migrations.AlterField(
            model_name='workforuspage',
            name='body',
        ...
        migrations.AlterField(
            model_name='workforuspage',
            name='team_stories',
            field=wagtail.fields.StreamField([('team_story', wagtail.blocks.StructBlock([('team_story_page', wagtail.blocks.PageChooserBlock(page_type=['general.General'], verbose_name='Story Page')), ('logo', wagtail.images.blocks.ImageChooserBlock())]))], blank=True, null=True, use_json_field=True, verbose_name='Team Stories'),
        ),
        migrations.AlterField(
            model_name='workforuspage',
            name='values',
            field=wagtail.fields.StreamField([('value', wagtail.blocks.StructBlock([('title', wagtail.blocks.CharBlock(icon='title', required=False)), ('excerpt', wagtail.blocks.TextBlock(required=False))]))], blank=True, null=True, use_json_field=True),
        ),
    ]
