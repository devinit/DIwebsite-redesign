const initPlotlyChart = async () => {
  ...
  if (wrappers.length) {
    ...
    register([
      await import('plotly.js/lib/bar' as any), // eslint-disable-line @typescript-eslint/no-explicit-any
      await import('plotly.js/lib/scatter' as any), // eslint-disable-line @typescript-eslint/no-explicit-any
    ]);
