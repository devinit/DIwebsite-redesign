...
export const updateDataHoverTemplate = (data: Plotly.Data[]) => {
  data.forEach((item) => {
...
export const updateLayoutColorway = (layout: Plotly.Layout) => {
  layout.colorway = [
    "#e84439",
    "#eb642b",
    "#f49b21",
...
export const removeTitle = (layout: Plotly.Layout) => {
    try {
        layout.title.text = '';
    } catch (e) {}
};
